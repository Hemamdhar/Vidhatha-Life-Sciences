      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            World-class infrastructure designed for excellence in pharmaceutical manufacturing
          </p>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Our manufacturing facility is equipped with 110.50 KL capacity, featuring
                  well-equipped reactors of different volumes to suit various batch sizes.
                </p>
                <div className="grid grid-cols-2 gap-4">
                  <Card>
                    <CardContent className="pt-6 text-center">
                      <p className="text-3xl font-bold text-primary">16</p>
                      <p className="text-sm text-muted-foreground">SS Reactors</p>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent className="pt-6 text-center">
                      <p className="text-3xl font-bold text-primary">8</p>
                      <p className="text-sm text-muted-foreground">GL Reactors</p>
                    </CardContent>
                  </Card>
                </div>
          ...
          <TabsContent value="quality" className="space-y-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Modern and well-equipped Quality Control laboratory ensuring our products are
                  pure, safe, and effective. Following GLP & cGMP standards.
                </p>
          ...
          <TabsContent value="warehouse" className="space-y-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Warehouse established with appropriate facilities and qualified personnel with
                  established procedures following Schedule M & ICH Q7 guidelines.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center gap-3">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="hover:shadow-elegant transition-all">
                <CardContent className="pt-6">
                  ...
                  <p className="text-muted-foreground mb-2">APSEB: 500 KVA</p>
                  <p className="text-sm text-muted-foreground">DG Sets: 500 KVA + 380 KVA</p>
                </CardContent>
              </Card>
              <Card className="hover:shadow-elegant transition-all">
                <CardContent className="pt-6">
                  <Beaker className="w-12 h-12 mb-4 text-primary" />
                  <h4 className="text-xl font-semibold mb-2">Cooling</h4>
                  <p className="text-muted-foreground mb-2">28 TR Chilling</p>
                  <p className="text-sm text-muted-foreground">
                    Cooling Towers: 300 TR & 200 TR
                  </p>
                </CardContent>
              </Card>
              <Card className="hover:shadow-elegant transition-all">
                <CardContent className="pt-6">
                  ...
                  <p className="text-muted-foreground mb-2">Air Compressor</p>
                  <p className="text-sm text-muted-foreground">7 Kg/cm² Pressure</p>
                </CardContent>
              </Card>
              <Card className="hover:shadow-elegant transition-all">
                <CardContent className="pt-6">
                  ...
                  <p className="text-muted-foreground mb-2">Boiler System</p>
                  <p className="text-sm text-muted-foreground">2 TPH Capacity</p>
                </CardContent>
              </Card>
            </div>
          </TabsContent>
